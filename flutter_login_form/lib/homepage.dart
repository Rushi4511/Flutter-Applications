...
import 'package:flutter_login_form/taskapp.dart';
  ...
  void submit(bool toEdit, [index]) {
    if (toEdit == true) {
      ...
      if (taskController.text.trim().isNotEmpty &&
        ...
        taskList
            .add(Task(title: taskController.text, date: dateController.text));
      }
    }
    clearController();
    setState(() {});
              ...
              children: [
                Text(
                  ...
                  style: GoogleFonts.inriaSerif(
                      ...
                      color: const Color.fromRGBO(31, 28, 29, 1)),
                ),
                const SizedBox(
                  height: 20,
                ),
          ...
          Container(
            ...
            child: Text(date,
                style: GoogleFonts.inriaSerif(
                    fontSize: 18,
                    fontWeight: FontWeight.w800,
                    color: const Color.fromRGBO(172, 189, 161, 1))),
          ),
          const SizedBox(
            height: 20,
          ),
