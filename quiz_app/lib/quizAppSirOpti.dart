  ...
  Color? colorsPicker(int selectedIndex) {
    if (selectedOptIndex != -1) {
      if (selectedIndex == queList[queIndex]["correctOpt"]) {
        return Colors.green;
      } else if (selectedIndex == selectedOptIndex) {
        return Colors.red;
      } else {
        return null;
      }
        ...
        body: SizedBox(
          ...
          child: Column(
            children: [
              ...
              (1 <= queList[queIndex]["options"].length)
                  ? ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: colorsPicker(0),
                      ...
                      onPressed: (selectedOptIndex == -1)
                          ...
                          : () {},
                      child: Text(queList[queIndex]["options"][0],
                          style: const TextStyle(
              ...
              (2 <= queList[queIndex]["options"].length)
                  ? ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: colorsPicker(1),
                        minimumSize: const Size(60, 60),
                        shadowColor: const Color.fromARGB(255, 127, 0, 254),
                        surfaceTintColor:
                            const Color.fromARGB(255, 217, 5, 236),
                      ...
                      onPressed: (selectedOptIndex == -1)
                          ...
                          : () {},
                      child: Text(queList[queIndex]["options"][1],
                          style: const TextStyle(
                              fontWeight: FontWeight.w600,
                              fontSize: 20,
                              color: Colors.black)),
              ...
              (3 <= queList[queIndex]["options"].length)
                  ? ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: colorsPicker(2),
                        minimumSize: const Size(60, 60),
                        shadowColor: const Color.fromARGB(255, 127, 0, 254),
                        surfaceTintColor:
                            const Color.fromARGB(255, 217, 5, 236),
                      ...
                      onPressed: (selectedOptIndex == -1)
                          ...
                          : () {},
                      child: Text(queList[queIndex]["options"][2],
                          style: const TextStyle(
                              fontWeight: FontWeight.w600,
                              fontSize: 20,
                              color: Colors.black)),
              ...
              (4 <= queList[queIndex]["options"].length)
                  ? ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        backgroundColor: colorsPicker(3),
                        minimumSize: const Size(60, 60),
                        shadowColor: const Color.fromARGB(255, 127, 0, 254),
                        surfaceTintColor:
                            const Color.fromARGB(255, 217, 5, 236),
                      ...
                      onPressed: (selectedOptIndex == -1)
                          ...
                          : () {},
                      child: Text(queList[queIndex]["options"][3],
                          style: const TextStyle(
                              fontWeight: FontWeight.w600,
                              fontSize: 20,
                              color: Colors.black)),
