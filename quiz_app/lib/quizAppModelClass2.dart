          ...
          child: Center(
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: const [
                  BoxShadow(
                      color: Color.fromARGB(255, 238, 74, 197),
                      offset: Offset(4.0, 4.0),
                      blurRadius: 15,
                      spreadRadius: 1.0),
                  BoxShadow(
    ...
    if (startQuiz) {
      return Scaffold(
          ...
          body: Container(
            height: double.infinity,
            width: double.infinity,
            color: Color.fromARGB(255, 226, 236, 236),
            child: Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    decoration: BoxDecoration(
                        ...
                        boxShadow: const [
                          BoxShadow(
                              color: Color.fromARGB(255, 247, 116, 236),
                              offset: Offset(10, 10),
                              blurRadius: 8,
                              spreadRadius: 1),
                        ]),
                  ...
                  ElevatedButton(
                      ...
                      child: const Text("Start Quiz -->",
                          style: TextStyle(
                              fontSize: 21.7,
                              fontWeight: FontWeight.w500,
                              color: Color.fromARGB(255, 93, 9, 173)))),
                  const SizedBox(
                    height: 15,
                  ),
                  TextButton(
                      ...
                      child: const Text("not now(close)",
                          style: TextStyle(
                              fontSize: 16.8,
                              fontWeight: FontWeight.w500,
                              color: Colors.blue)))
